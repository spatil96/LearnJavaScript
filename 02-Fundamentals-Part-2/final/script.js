...
// This should be the first line in the script file, comments are ignored by JS. So, they can come before this.
//Can be done for block or whole file.
/*
  1. The entire contents of JavaScript modules are automatically in strict mode, with no statement needed to initiate it.
  2. All parts of a class's body are strict mode code, including both class declarations and class expressions.
